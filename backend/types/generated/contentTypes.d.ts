...
export interface ApiCommunityCommunity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Jewish communities across Belarus';
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'IRO projects and initiatives';
    displayName: 'Project';
    pluralName: 'projects';
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings, labels and texts';
  ...
  attributes: {
    communities_description: Schema.Attribute.Text;
    communities_title: Schema.Attribute.String;
